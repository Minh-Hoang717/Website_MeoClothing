    ...
    <div class="admin-content">
        ...
        <form method="POST" class="promotion-form">
            <div class="form-row">
                ...
                <div class="form-group">
                    ...
                    <select id="discount_type" name="discount_type" required onchange="updateValueLabel()">
                        ...
                        <option value="percentage" <?php echo ($discountType ?? '') === 'percentage' ? 'selected' : ''; ?>>
                            Phần Trăm (%)
                        </option>
                        <option value="fixed" <?php echo ($discountType ?? '') === 'fixed' ? 'selected' : ''; ?>>
                            Tiền Cố Định (đ)
                        </option>
                    </select>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="input-with-unit">
                        <input type="number" id="discount_value" name="discount_value" 
                               value="<?php echo htmlspecialchars($discountValue ?? ''); ?>" 
            ...
            <div class="form-actions">
                <button type="submit" class="btn-submit">Tạo Mã Khuyến Mãi</button>
        ...
        <div class="info-box">
            <h3>ℹ️ Hướng Dẫn</h3>
            <ul>
                <li><strong>Mã Khuyến Mãi:</strong> Nhập mã ngắn gọn, dễ nhớ (VD: SUMMER20, SAVE10)</li>
                <li><strong>Loại Giảm:</strong> Chọn giảm theo phần trăm hoặc tiền cố định</li>
                <li><strong>Giá Trị:</strong> Nếu là %, không được vượt quá 100%; Nếu là tiền, tính bằng VNĐ</li>
                <li><strong>Ngày Hạn:</strong> Mã chỉ hoạt động từ ngày bắt đầu đến ngày kết thúc</li>
            </ul>
        </div>
    </div>
</section>
